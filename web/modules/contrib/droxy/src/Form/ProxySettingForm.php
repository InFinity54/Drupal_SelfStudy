...
class ProxySettingForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['proxy_scheme'] = [
      '#type' => 'select',
      '#title' => $this->t('Https or Https'),
      '#description' => $this->t('type of Scheme'),
      '#options' => ['http' => 'HTTP','HTTP' => 'HTTPS'],
      '#default_value' => $config->get('proxy_scheme'),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('droxy.proxysetting')
      ->set('proxy_scheme', $form_state->getValue('proxy_sheme'))
